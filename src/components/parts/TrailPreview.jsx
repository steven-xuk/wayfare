...
function TrialPreview({title, description, short_description, image, likes, creatorName}) {
        ...
        <div className='trail-preview'>
            <div className='preview-top'>
                <div className='preview-content-container'>
                    ...
                    <p className='preview-content short'>{shortDescriptionState}{shortDescriptionState.slice(-4, -1) === '...' ? <Link to='/home'>Read more</Link> : null}</p>
